<div class="min-h-screen bg-[#f8fafc]">
        ...
        <div class="mx-auto w-full max-w-[1500px] px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-body text-gray-500 mt-0.5">Ringkasan operasional hari ini</p>
                </div>
    ...
    <div class="mx-auto w-full max-w-[1500px] px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-6 space-y-6">
            ...
            <a href="{{ route('admin.verification') }}" wire:navigate class="group bg-white rounded-[12px] border border-gray-100 p-5 hover:shadow-card-hover hover:border-gray-200 transition-all duration-200">
                <div class="flex items-start justify-between mb-4">
                    ...
                    @if($pendingVerifications > 0)
                        <span class="text-caption font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">Perlu Aksi</span>
                    @endif
                </div>
                <div class="text-[28px] font-bold text-gray-900 leading-none">{{ $pendingVerifications }}</div>
                <div class="text-caption text-gray-500 mt-1">Verifikasi Pembayaran</div>
            </a>
            ...
            <a href="{{ route('admin.boxes') }}" wire:navigate class="group bg-white rounded-[12px] border border-gray-100 p-5 hover:shadow-card-hover hover:border-gray-200 transition-all duration-200">
                <div class="flex items-start justify-between mb-4">
                    ...
                    @if($pendingCheckouts > 0)
                        <span class="text-caption font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">Perlu Proses</span>
                    @endif
                </div>
                <div class="text-[28px] font-bold text-gray-900 leading-none">{{ $pendingCheckouts }}</div>
                <div class="text-caption text-gray-500 mt-1">Checkout Menunggu</div>
            </a>
            ...
            <a href="{{ route('admin.customers') }}" wire:navigate class="group bg-white rounded-[12px] border border-gray-100 p-5 hover:shadow-card-hover hover:border-gray-200 transition-all duration-200">
                <div class="flex items-start justify-between mb-4">
                    ...
                    @if($customerPending > 0)
                        <span class="text-caption font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">{{ $customerPending }} baru</span>
                    @endif
                </div>
                <div class="text-[28px] font-bold text-gray-900 leading-none">{{ $customerActive }}</div>
                <div class="text-caption text-gray-500 mt-1">Customer Aktif <span class="text-gray-400">/ {{ $totalCustomers }} total</span></div>
            </a>
            ...
            <a href="{{ route('admin.customers') }}" wire:navigate class="group bg-white rounded-[12px] border border-gray-100 p-5 hover:shadow-card-hover hover:border-gray-200 transition-all duration-200">
                <div class="flex items-start justify-between mb-4">
                    ...
                    @if($pendingComplaints > 0)
                        <span class="text-caption font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded-full">Perlu Tindak</span>
                    @endif
                </div>
                <div class="text-[28px] font-bold text-gray-900 leading-none">{{ $pendingComplaints }}</div>
                <div class="text-caption text-gray-500 mt-1">Komplain Terbuka</div>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-[12px] border border-gray-100">
                <div class="px-5 py-4 border-b border-gray-100">
                    <h3 class="text-body font-semibold text-gray-900">Status Box</h3>
                </div>
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div class="rounded-[10px] border border-gray-100 p-4">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="text-caption font-semibold text-gray-700 uppercase tracking-wide">Sharing</span>
                            </div>
                            <div class="flex items-end justify-between">
                                <div>
                                    <span class="text-[22px] font-bold text-gray-900">{{ $sharingOpen }}</span>
                                    <span class="text-caption text-gray-400 ml-1">aktif</span>
                                </div>
                                <span class="text-caption text-gray-400">{{ $sharingClosed }} selesai</span>
                            </div>
                        ...
                        <div class="rounded-[10px] border border-gray-100 p-4">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="text-caption font-semibold text-gray-700 uppercase tracking-wide">Direct</span>
                            </div>
                            <div class="flex items-end justify-between">
                                <div>
                                ...
                                <span class="text-caption text-gray-400">{{ $directClosed }} selesai</span>
                            </div>
                            <div class="mt-3 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                        ...
                        <div class="rounded-[10px] border border-gray-100 p-4">
                            <div class="flex items-center gap-2 mb-3">
                                ...
                                <span class="text-caption font-semibold text-gray-700 uppercase tracking-wide">Handcarry</span>
                            </div>
                            <div class="flex items-end justify-between">
                                <div>
                                ...
                                <span class="text-caption text-gray-400">{{ $handcarryClosed }} selesai</span>
                            </div>
                            <div class="mt-3 h-1.5 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div class="bg-white rounded-[12px] border border-gray-100">
                ...
                <div class="p-4">
                    <div class="grid grid-cols-2 gap-2">
                        <a href="{{ route('admin.verification') }}" wire:navigate class="flex flex-col items-center gap-2 p-3 rounded-[10px] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-accent/40 transition-colors group">
                            ...
                            <span class="text-caption font-medium text-gray-600">Verifikasi</span>
                        </a>
                        ...
                        <a href="{{ route('admin.est-update') }}" wire:navigate class="flex flex-col items-center gap-2 p-3 rounded-[10px] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-accent/40 transition-colors group">
                            ...
                            <span class="text-caption font-medium text-gray-600">Est Update</span>
                        </a>
                        <a href="{{ route('admin.recap') }}" wire:navigate class="flex flex-col items-center gap-2 p-3 rounded-[10px] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-accent/40 transition-colors group">
                            ...
                            <span class="text-caption font-medium text-gray-600">Recap</span>
                        </a>
                        <a href="{{ route('admin.customers') }}" wire:navigate class="flex flex-col items-center gap-2 p-3 rounded-[10px] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-accent/40 transition-colors group">
                            ...
                            <span class="text-caption font-medium text-gray-600">Customer</span>
                        </a>
            ...
            <div class="bg-white rounded-[12px] border border-gray-100">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    ...
                    @if($notifications->where('read_at', null)->count() > 0)
                        <span class="text-caption font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">{{ $notifications->where('read_at', null)->count() }} baru</span>
                    @endif
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-[12px] border border-gray-100">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-body font-semibold text-gray-900">Menunggu Pembayaran</h3>
                    <a href="{{ route('admin.invoices') }}" wire:navigate class="text-caption text-accent hover:text-primary font-medium transition-colors">Lihat Semua</a>
                </div>
                @if($deadlinePayments->isEmpty())
                    <div class="p-5 text-center">
                        <p class="text-body text-gray-400">Tidak ada invoice menunggu pembayaran</p>
                    </div>
                @else
                    <div class="divide-y divide-gray-50">
                        @foreach($deadlinePayments as $invoice)
                            <div class="flex items-center justify-between px-5 py-3.5 hover:bg-gray-50/50 transition-colors">
                                <div class="min-w-0">
                                    <p class="text-body font-medium text-gray-800 truncate">{{ $invoice->invoice_number }}</p>
                                    <p class="text-caption text-gray-500">{{ $invoice->customer->name ?? '-' }}</p>
                                </div>
                                <div class="text-right flex-shrink-0 ml-4">
                                    <p class="text-body font-semibold text-gray-900">Rp {{ number_format($invoice->grand_total, 0, ',', '.') }}</p>
                                    <p class="text-caption text-gray-400">{{ $invoice->created_at->diffForHumans() }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="bg-white rounded-[12px] border border-gray-100">
                <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-body font-semibold text-gray-900">Box Aktif</h3>
                    <a href="{{ route('admin.boxes') }}" wire:navigate class="text-caption text-accent hover:text-primary font-medium transition-colors">Lihat Semua</a>
                </div>
                @if($deadlineStorages->isEmpty())
                    <div class="p-5 text-center">
                        <p class="text-body text-gray-400">Tidak ada box aktif</p>
                    </div>
                @else
                    <div class="divide-y divide-gray-50">
