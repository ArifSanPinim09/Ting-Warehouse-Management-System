        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center bg-gray-100 rounded-button p-1">
                    <a href="{{ route('customer.box.sharing') }}" wire:navigate class="px-4 py-2 rounded-button text-body font-medium transition-colors bg-white text-primary shadow-sm">Sharing</a>
                    <a href="{{ route('customer.box.direct') }}" wire:navigate class="px-4 py-2 rounded-button text-body font-medium transition-colors text-gray-500 hover:text-gray-700">Direct</a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    @foreach($box->items as $item)
                                        <div class="px-5 py-4 flex items-center justify-between gap-4">
                                            ...
                                            <div class="flex items-center gap-2 flex-shrink-0">
                                                ...
                                                @endif
                                                @if($item->proof_co)
                                                    <button class="p-1.5 rounded-button text-gray-400 hover:text-accent hover:bg-accent/5 transition-colors" title="Lihat foto">
