    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-4">
        ...
        <div class="bg-white rounded-[12px] border border-gray-100 overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-100">
                <h3 class="text-[15px] font-semibold text-gray-900">Daftar Box Direct</h3>
                ...
                <div class="relative bg-white rounded-[16px] shadow-modal w-full max-w-4xl max-h-[90vh] overflow-hidden transform transition-all" @click.stop>
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 rounded-[10px] bg-violet-50 flex items-center justify-center">
                            ...
                            <div>
                                <h3 class="text-[16px] font-semibold text-gray-900">Detail Box Direct</h3>
                                <p class="text-body text-gray-500 mt-0.5">{{ $detailBox->tracking_number ?? $detailBox->batch_name ?? 'Box #' . $detailBox->id }}</p>
                            </div>
                        </div>
