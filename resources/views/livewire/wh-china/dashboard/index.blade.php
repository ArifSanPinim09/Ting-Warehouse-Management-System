            ...
            <div class="px-6 py-4 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        {{-- REV-03.9: Filter by Huruf Box --}}
                        <select wire:model.live="filterHurufBox"
                            class="py-2 px-3 text-[13px] bg-white border border-gray-200 rounded-[8px] focus:border-accent focus:ring-2 focus:ring-accent/40 transition-colors text-gray-600">
                            <option value="">All Boxes</option>
                            @foreach($hurufBoxOptions as $huruf)
                                <option value="{{ $huruf }}">{{ $huruf }}</option>
                            @endforeach
                        </select>
                        {{-- REV-03.9: Export Button --}}
                        <a href="{{ route('china.export-service-fee', ['huruf_box' => $filterHurufBox]) }}"
                            class="px-3 py-2 text-[13px] font-medium text-white bg-emerald-600 rounded-[8px] hover:bg-emerald-700 transition-colors inline-flex items-center gap-1.5">
