                        ...
                        $navSections = [
                            ...
                            [
                                ...
                                'items' => [
                                    ...
                                    ['label' => 'Pencari Resi', 'route' => 'admin.resi-search', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>'],
                                    ['label' => 'Edit Status', 'route' => 'admin.item-status', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>'],
                                ],
                            ],
                            // ─── Pengaturan ────────────────────────────
                            [
                        ...
                        if ($isOwner) {
                            ...
                            $navSections[] = [
                                ...
                                'items' => [
                                    ...
                                    ['label' => 'Kurs Management', 'route' => 'owner.kurs', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>'],
                                    ...
                                    ['label' => 'Pencari Resi', 'route' => 'owner.resi-search', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>'],
                                ],
                            ];
                        }
                    @endphp
